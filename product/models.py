...
class ItemInfo(DeclarativeBase):
    ...
    tag_source = Column('tag_source', Text)
    ...
    sub_category = Column('sub_category', Integer,  default = 0)
    brand = Column('brand', Integer,  default = 0)
    detail_images = Column('detail_images', String(4000))
    thumb_images = Column('thumb_images', String(500))
    suitable_images = Column('suitable_images', String(500))
    white_suitable = Column('white_suitable', String(500))
    tag_status = Column('tag_status', SmallInteger)
    visenze_result = Column('visenze_result', Text)
    merchant = Column('merchant', Integer,  default=0)
    ...
    buy_size = Column('buy_size', String(500), default='[]')
    buy_color = Column('buy_color', String(500), default='[]')
